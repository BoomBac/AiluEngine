...
namespace Ailu
{
    namespace Editor
    {
        ...
        void RenderView::ProcessTransformGizmo()
        {
        ...
        void RenderView::OnActorPlaced(String obj_type)
        {
            auto ray_dir = ScreenPosToWorldDir(GlobalToLocal(Input::GetMousePos()));
            ...
            if (p_closetest_obj && p_closetest_obj->HasComponent<StaticMeshComponent>())
            {
                ...
                place_pos.y += box.Size().y * 0.5f + 200.0f;
                ...
                if (p.Intersect(Camera::sCurrent->Position(), ray_dir, place_pos))
                    ...
                    Gizmo::DrawCube(place_pos, Vector3f{200.f, 200.f, 200.f},Colors::kRed);
            }
