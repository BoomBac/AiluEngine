...
bool RTXDI_InternalSimpleResample(
    ...
    float random,
    float targetPdf = 1.0,            // Usually closely related to the sample normalization, 
    float sampleNormalization = 1.0,  //     typically off by some multiplicative factor 
    float sampleM = 1.0               // In its most basic form, should be newReservoir.M
)
{
