...
#undef CreateFile
    ...
    public:
        ...
        static bool ReadFile(const WString &sys_path, std::stringstream& ss);
    ...
    public:
    private:
        inline static WString s_cur_path_str;
        inline static WString s_cur_dir_str;
        inline static fs::path s_cur_path;
    };
}// namespace Ailu
