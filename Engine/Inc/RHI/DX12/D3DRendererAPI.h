...
namespace Ailu
{
	...
	public:
		...
		void Clear() override;
		void DrawIndexedInstanced(const std::shared_ptr<IndexBuffer>& index_buffer, uint32_t instance_count) override;
		void DrawInstanced(const std::shared_ptr<VertexBuffer>& vertex_buf, uint32_t instance_count) override;
	private:
