...
builder_size._offset = offsetof(CanvasSlot,_size);
...
builder_cross_align._type_name = "EAlignment";
...
meta_is_size_to_content.Set("RangeMin",(f32)0);
meta_is_size_to_content.Set("RangeMax",(f32)1);
