...
namespace Ailu
{
	...
	public:
		...
		static ALHash::Hash<64> ConstuctPSOHash(u8 input_layout,u16 vs,u32 ps,u8 topology,u8 blend_state,u8 raster_state,u8 ds_state,u8 rt_state);
		static ALHash::Hash<64> ConstuctPSOHash(const GraphicsPipelineStateInitializer& initializer);
	...
	public:
		...
		static void ConfigurePSOHash(ALHash::Hash<64>& pso_hash, u8 input_layout, u16 vs, u32 ps, u8 topology, u8 blend_state, u8 raster_state, u8 ds_state, u8 rt_state);
	...
	private:
		...
		inline static u16 s_hash_vs; //4~13 10
		inline static u32 s_hash_ps; // 14~35 22
