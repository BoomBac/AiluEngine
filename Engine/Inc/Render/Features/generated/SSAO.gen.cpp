...
meta_is_cbr.Set("RangeMin",(f32)0);
meta_is_cbr.Set("RangeMax",(f32)1);
...
meta_is_half_res.Set("RangeMin",(f32)0);
meta_is_half_res.Set("RangeMax",(f32)1);
...
return Ailu::Render::SSAO::StaticType();
    ...
    const Type *Ailu::Render::SSAO::GetType()
{
