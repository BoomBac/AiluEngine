...
namespace Ailu
{
    namespace Render
    {
        ...
        {
            if (src != dst) memcpy(dst, src, sizeof(*dst));
            return *dst;
        }
    ...
    namespace Math::ALHash
    {
        ...
        static u32 HashFunc(const Ailu::Render::ETopology &obj)
        {
            switch (obj)
            {
                case Ailu::Render::ETopology::kPoint:
                    return 0;
                case Ailu::Render::ETopology::kLine:
                    return 1;
                case Ailu::Render::ETopology::kTriangle:
                    return 2;
                case Ailu::Render::ETopology::kPatch:
                    return 3;
            }
            return 2;
        }
    ...
    namespace Render
    {
        ...
        public:
            ...
            static u8 GenHash(T &obj)
            {
                ...
                for (u32 i = 0; i < _s_data.size(); i++) { if (_s_data[i] == obj) return i; }
        ...
        public:
            ...
            const VertexBufferLayoutDesc &operator[](const int &index) { return _buffer_descs[index]; }
        ...
        private:
            void CalculateSizeAndStride()
            {
                ...
                for (size_t i = 0; i < kMaxStreamCount; i++) { if (_stride[i] != 0) ++_stream_count; }
            }
        ...
        public:
            ...
            bool operator==(const RenderTargetState &other) const
            {
                ...
                else { for (int i = 0; i < _color_rt_num; i++) is_equal &= this->_color_rt[i] == other._color_rt[i]; }
                return is_equal;
            }

            RenderTargetState &operator=(const RenderTargetState &other) { return PODCopy(&other, this); }
        ...
        {
        public:
            static BlendState GetRHI() { return BlendState(enable, src_color, src_alpha); }
        };
        ...
        {
        public:
            static RasterizerState GetRHI() { return RasterizerState(cull_mode, fill_mode); }
        };
        ...
        {
        public:
            static DepthStencilState GetRHI() { return DepthStencilState(DepthWrite, DepthTest); }
        };
