...
namespace Ailu
{
	...
	public:
		...
		static constexpr EALGFormat kDefaultDepthRTFormat = EALGFormat::kALGFormatD32_FLOAT;
	...
	public:
		...
		{
			return memcmp(this,&other,sizeof(RenderTargetState));
		}
	...
	namespace PipelineStateAA
	{
		inline static RenderTargetState ps[8]{};
	}
