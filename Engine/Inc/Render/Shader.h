...
namespace Ailu
{
	...
	public:
		...
		const VertexInputLayout& PipelineInputLayout(u16 pass_index, ShaderVariantHash variant_hash) const { return _passes[pass_index]._variants.at(variant_hash)._pipeline_input_layout; };
		const RasterizerState& PipelineRasterizerState(u16 pass_index, ShaderVariantHash variant_hash) const { return _passes[pass_index]._pipeline_raster_state; };
