...
#define VAILD_SHADER_ID(id) id != ShaderLibrary::s_error_id
	...
	public:
		...
		{
			inline static const String kErrorFallback = "Shaders/error_fallback.hlsl__";
		...
		static Ref<Shader> GetErrorFallback()
		{
			static auto error_index = NameToId("Shaders/error_fallback.hlsl__");
			return s_shader_library[error_index];
		}
