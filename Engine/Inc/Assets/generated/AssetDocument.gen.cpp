...
Meta meta_root_motion;
meta_root_motion.Set("Category","");
meta_root_motion.Set("IsColor",false);
meta_root_motion.Set("IsRange",false);
meta_root_motion.Set("IsFloatRange",true);
meta_root_motion.Set("RangeMin",(f32)0);
meta_root_motion.Set("RangeMax",(f32)1);
MemberBuilder builder_root_motion;
builder_root_motion._name = "_root_motion";
builder_root_motion._type_name = "Ailu::RootMotionSettings";
builder_root_motion._offset = offsetof(AnimationClipAssetDocument,_root_motion);
builder_root_motion._is_const = false;
builder_root_motion._is_static = false;
builder_root_motion._is_public = true;
builder_root_motion._is_pointer = false;
builder_root_motion._is_ref = false;
builder_root_motion._is_template = false;
builder_root_motion._meta = meta_root_motion;
builder_root_motion._serialize_fn = static_cast<SerializeFunc>(&SerializePrimitive<RootMotionSettings>);
builder_root_motion._deserialize_fn = static_cast<DeserializeFunc>(&DeserializePrimitive<RootMotionSettings>);
initializer._properties.emplace_back(MemberBuilder::BuildProperty(builder_root_motion));
Meta meta_skeleton;
meta_skeleton.Set("Category","");
meta_skeleton.Set("IsColor",false);
meta_skeleton.Set("IsRange",false);
...
builder_skeleton._name = "_skeleton";
builder_skeleton._type_name = "Ailu::Guid";
builder_skeleton._offset = offsetof(AnimationClipAssetDocument,_skeleton);
builder_skeleton._is_const = false;
builder_skeleton._is_static = false;
builder_skeleton._is_public = true;
builder_skeleton._is_pointer = false;
...
builder_preset._type_name = "ECS::ECollisionPreset2D";
builder_preset._offset = offsetof(SceneCollider2DComponentDocument,_preset);
builder_preset._is_const = false;
builder_preset._is_static = false;
builder_preset._is_public = true;
...
builder_preset._serialize_fn = static_cast<SerializeFunc>(&SerializePrimitive<ECS::ECollisionPreset2D>);
builder_preset._deserialize_fn = static_cast<DeserializeFunc>(&DeserializePrimitive<ECS::ECollisionPreset2D>);
...
builder_collision_profile._type_name = "ECS::CollisionProfile2D";
builder_collision_profile._offset = offsetof(SceneCollider2DComponentDocument,_collision_profile);
builder_collision_profile._is_const = false;
builder_collision_profile._is_static = false;
builder_collision_profile._is_public = true;
...
builder_collision_profile._serialize_fn = static_cast<SerializeFunc>(&SerializePrimitive<ECS::CollisionProfile2D>);
builder_collision_profile._deserialize_fn = static_cast<DeserializeFunc>(&DeserializePrimitive<ECS::CollisionProfile2D>);
...
Meta meta_root_motion_mode;
meta_root_motion_mode.Set("Category","");
meta_root_motion_mode.Set("IsColor",false);
meta_root_motion_mode.Set("IsRange",false);
meta_root_motion_mode.Set("IsFloatRange",true);
meta_root_motion_mode.Set("RangeMin",(f32)0);
meta_root_motion_mode.Set("RangeMax",(f32)1);
MemberBuilder builder_root_motion_mode;
builder_root_motion_mode._name = "_root_motion_mode";
builder_root_motion_mode._type_name = "u8";
builder_root_motion_mode._offset = offsetof(SceneAnimatorComponentDocument,_root_motion_mode);
builder_root_motion_mode._is_const = false;
builder_root_motion_mode._is_static = false;
builder_root_motion_mode._is_public = true;
builder_root_motion_mode._is_pointer = false;
builder_root_motion_mode._is_ref = false;
builder_root_motion_mode._is_template = false;
builder_root_motion_mode._meta = meta_root_motion_mode;
builder_root_motion_mode._serialize_fn = static_cast<SerializeFunc>(&SerializePrimitive<u8>);
builder_root_motion_mode._deserialize_fn = static_cast<DeserializeFunc>(&DeserializePrimitive<u8>);
initializer._properties.emplace_back(MemberBuilder::BuildProperty(builder_root_motion_mode));
cur_type = std::make_unique<Ailu::Type>(initializer);
Ailu::Type::RegisterType(cur_type.get());
}
return cur_type.get();
