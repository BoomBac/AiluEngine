...
namespace Ailu
{
	...
	void GraphicsPipelineStateMgr::BuildPSOCache()
	{
		...
		Shader* shader = g_pResourceMgr->Load<Shader>(L"Shaders/defered_standard_lit.hlsl");
		...
		shader = g_pResourceMgr->Load<Shader>(L"Shaders/deferred_lighting.hlsl",&setting);
		...
		memset(&pso_desc, 0, sizeof(GraphicsPipelineStateInitializer));
		shader = g_pResourceMgr->Load<Shader>(L"Shaders/blit.hlsl");
		pso_desc = GraphicsPipelineStateInitializer::GetNormalOpaquePSODesc();
		pso_desc._input_layout = shader->PipelineInputLayout();
		pso_desc._p_vertex_shader = shader;
		pso_desc._p_pixel_shader = shader;
		...
		memset(&pso_desc, 0, sizeof(GraphicsPipelineStateInitializer));
		shader = g_pResourceMgr->Load<Shader>(L"Shaders/wireframe.hlsl");
		pso_desc._p_vertex_shader = shader;
		pso_desc._p_pixel_shader = shader;
		...
		memset(&pso_desc, 0, sizeof(GraphicsPipelineStateInitializer));
		shader = g_pResourceMgr->Load<Shader>(L"Shaders/gizmo.hlsl");
		...
		memset(&pso_desc, 0, sizeof(GraphicsPipelineStateInitializer));
		shader = g_pResourceMgr->Load<Shader>(L"Shaders/depth_only.hlsl");
		pso_desc._input_layout = shader->PipelineInputLayout();
		...
		memset(&pso_desc, 0, sizeof(GraphicsPipelineStateInitializer));
		shader = g_pResourceMgr->Load<Shader>(L"Shaders/cubemap_gen.hlsl");
		pso_desc._input_layout = shader->PipelineInputLayout();
		pso_desc._blend_state = shader->PipelineBlendState();
		pso_desc._raster_state = shader->PipelineRasterizerState();
		pso_desc._depth_stencil_state = shader->PipelineDepthStencilState();
		...
		memset(&pso_desc, 0, sizeof(GraphicsPipelineStateInitializer));
		shader = g_pResourceMgr->Load<Shader>(L"Shaders/filter_irradiance.hlsl");
		pso_desc._input_layout = shader->PipelineInputLayout();
		pso_desc._blend_state = shader->PipelineBlendState();
		pso_desc._raster_state = shader->PipelineRasterizerState();
		pso_desc._depth_stencil_state = shader->PipelineDepthStencilState();
