...
namespace Ailu
{
	...
	int ResourceMgr::Initialize()
	{
		...
		}
		{
			...
			Load<Texture2D>(EnginePath::kEngineIconPathW + L"light_probe.alasset");
			Load<Texture2D>(EnginePath::kEngineTexturePathW + L"ibl_brdf_lut.alasset");
			Load<Texture2D>(EnginePath::kEngineTexturePathW + L"T_Default_Material_Grid_N.alasset");
			Load<Texture2D>(EnginePath::kEngineTexturePathW + L"T_Default_Material_Grid_M.alasset");
